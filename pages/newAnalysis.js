                    ...
                    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                           {/*} <li>
                              ...
                              <li>
                                <a href="panel" className="block py-2 pr-4 pl-3 text-white rounded   md:p-0 text-white" aria-current="page">Analizler</a>
                            </li>
                            <li>
                                <a href="#" className="block py-2 pr-4 pl-3 text-white rounded   md:p-0 text-white" aria-current="page">Yeni Analiz</a>
                            </li>
                            <li>
