...
export default function Analysis() {
    ...
    const downloadAnalysis = async (e) => {        
        try{
            window.open(`${ApiUrl}/analysis/download?analysis_code=${analysisCode}`,'_blank')
            var response = await axios.get(`${ApiUrl}/analysis/download?analysis_code=${analysisCode}`)
        }
        catch(e){
            console.log(e.toString())
        }                        
                                            ...
                                            <table className="w-full text-sm text-left text-gray-500 text-gray-400">
                                                <thead className="text-xs text-gray-700 uppercase bg-gray-50 bg-gray-700 text-gray-400">
                                                    <tr>
                                                        ...
                                                        <button className="bg-white hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={(e) => downloadAnalysis(e)}>
                                                                İndir
                                                        </button>
                                                        </th>
                                                    </tr>
