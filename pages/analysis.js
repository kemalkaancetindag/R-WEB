        ...
        <>
            {
                analysis && analysis.is_model_ready ? (
                    <div className="grid grid-rows-12 grid-cols-12" >
                        <aside class="col-span-2 row-span fixed" aria-label="Sidebar">
                            <div class="overflow-y-auto py-4 px-3 bg-gray-50  dark:bg-gray-800" style={{ height: "100vh" }}>
                                <div class="flex items-center pl-2.5 mb-5">
                                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Değişkenler</span>
                                </div>
                                {analysis && analysis.independent_variables.map((value, index) => {
                                    return (
                                        <ul class="space-y-2">
                                            ...
                                            <li>
                                                <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle={index} onClick={(e) => toggleDropdown(e)}>
                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                        width="30px" height="30px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xmlSpace="preserve">
                                    ...
                                    c0,0-5.3,3-7.1,0.6c-1.3-2.5-2.4-5.7-3.2-9.7c-0.8-3.6-1.7-7.8-2.5-11.9l5.3-7.7C61.9,37.6,67.8,39.7,70.9,39.7z"/>
                                                    ...
                                                    <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>{value.name}</span>
                                                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                                </button>
                                                <ul id={`dropdown-example-${index}`} class="py-2 space-y-2 can-toggle">

                                                    <li>
                                                        <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Tip: {value.type}</a>
                                                    </li>
                                                </ul>
                                            </li>
                        ...
                        <div className=" col-start-4 col-span-8 row-start-1 mt-10 ">
                            ...
                            <div className="flex justify-start mb-10">
                                <div>
                                    <div class="flex justify-center">
                                        <div class="mb-3 w-96">
                                            <label for="formFile" class="form-label inline-block mb-2 text-gray-700">Birden fazla tahmin girdisi</label>
                            ...
                            <form class="w-full ">
                                        ...
                                        if (!value.is_categoric) {
                                            return (
                                                <div class="w-1/4  px-3 mb-6 md:mb-0 ">
                                                    ...
                                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" my-data-type="num" var-name={value.name} />
                                                </div>
                                            )
                                        }
                                    })}
                                ...
                                <div className="flex flex-wrap -mx-3 mb-6">
                                    {analysis && analysis.independent_variables.map((value, key) => {
                                        if (value.is_categoric) {
                                            ...
                                            return (
                                                <div class="w-1/4  mb-6 md:mb-0 px-3">
                                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-state">
                                                        {value.name}
                                                    </label>
                                                    <div class="relative">
                                                        <select my-data-type="cat" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" var-name={value.name}>
                                ...
                                <div className="flex mt-5">
                                    <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={(e) => makePrediction(e)}>
                                        Tahminle
                                    </button>
                                ...
                                <>
                                    ...
                                    {isMultiple  ? (
                                        ...
                                        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10">
                                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                                    <tr>
                                                        ...
                                                        {multiplePrediction.analysis.independent_variables.slice(0, 4).map(variable => (
                                                        ...
                                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">                                                                                                                        
                                                            ...
                                                            <td class="px-6 py-4 text-right">
                                                                <button type="button" data-modal-toggle="defaultModal" onClick={(e) =>{ 
                                                                    ...
                                                                    handleModal(e)
                                                                    }} class="font-medium text-blue-600 dark:text-blue-500 hover:underline" prediction-index={index}>Analizi Göster</button>
                                                            </td>
                                                        </tr>
                                                    ))}
                                                    ...
                                                    <div>
                                                        <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                                            {_.times(totalPage).map((value,index) => (
                                                                 <a href="#" aria-current="page" onClick={() => setCurrentPage(index)} class="z-10 bg-indigo-50 border-indigo-500 text-indigo-600 relative inline-flex items-center px-4 py-2 border text-sm font-medium"> {index+1} </a>
                                                            ))}
                                            ...
                                            <div class="fixed z-10 inset-0  hidden overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="defaultModal">
                                                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                                    ...
                                                    <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                            ...
                                                            {predictionIndex && (
                                                                <div class="flex flex-wrap space-x-2 mt-10 justify-around">                                                                    
                                                              
                                                                {analysis.category_image_map_list.map(cim => (

                                                                     <div class="grid w-1/6 h-1/6 mb-5 ">                                                                                                                                                 
                                                                         <p className="justify-self-center mt-2">{cim.category}</p>
                                                                        <img class="rounded-full border border-gray-100 shadow-sm justify-self-center w-20 h-20" src={"http://localhost:3002/uploads/" + cim.image} alt="user image" />                                                                                                                                               
                                        ...
                                        <div class="flex flex-wrap space-x-2 mt-10 justify-center">
                                            ...
                                            {prediction && prediction.map((value, key) => {
                                                ...
                                                return (
                                                    <div class="grid w-1/6 h-1/6">
                                                        
                                                        <p className="justify-self-center mt-2">{value[0]}</p>
                                                        <img class="rounded-full border border-gray-100 shadow-sm justify-self-center w-20 h-20" src={"http://localhost:3002" +"/uploads/"+ image} alt="user image" />
                    ...
                    <div className="grid grid-rows-12 grid-cols-12" >
                        <aside class="col-span-2 row-span" aria-label="Sidebar" >
                            <div class="overflow-y-auto py-4 px-3 bg-gray-50 " style={{ height: "100vh" }}>
                                <div class="flex items-center pl-2.5 mb-5">
                                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Değişkenler</span>
                                </div>
                        ...
                        <div className=" col-start-4 col-span-8 row-start-1 mt-10 ">
                            <div class="relative flex flex-col sm:flex-row sm:items-center bg-white shadow rounded-md py-5 pl-6 pr-8 sm:pr-6">
                                <div class="flex flex-row items-center border-b sm:border-b-0 w-full sm:w-auto pb-4 sm:pb-0">
                                    ...
                                    <div class="text-sm font-medium ml-3">Analiz henüz hazır değil.</div>
                                </div>
                                <div class="text-sm tracking-wide text-gray-500 mt-4 sm:mt-0 sm:ml-4">Sayfayı yenileyerek tekrar deneyin. Analiziniz hazır olduğunda yüklenecek.</div>
